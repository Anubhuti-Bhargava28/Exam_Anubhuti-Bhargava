...
public class TestQues4B {
		...
		public static void main(String[] args) throws NumberFormatException, IOException {
			...
			System.out.println("Enter no of Records that to be entered:");
			int n = Integer.parseInt(bin.readLine());
			System.out.println("Enter records in the format of Name-Marks 1 subject-Marks 2 subject-Marks 3 subject-");
			for (int i = 0; i < n; i++) {
